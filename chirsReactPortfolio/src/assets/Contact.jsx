...
const ContactSection = () => {
    const handleOpenEmailClient = () => {
        window.location.href = 'mailto:Davischris25139@yahoo.com';
    };

    return (
        <section id="contact" className="container">
            <h2>Contact</h2>
            <a href="mailto:Davischris25139@yahoo.com" className="btn btn-primary" onClick={handleOpenEmailClient}>Davischris25139@yahoo.com</a>
        </section>
    );
};
